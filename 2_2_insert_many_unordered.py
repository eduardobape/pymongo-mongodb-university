...
def main(databaseName, collectionName):
	try:
		...
		# Al usar ordered=False, la película con id=003 se insertará, la película con id=002 no se insertará porque ya
		# hay otra película en la colección con el mismo _id (se producirá un error), pero las siguientes películas no
		# se insertarán
